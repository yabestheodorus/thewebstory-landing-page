    ...
    <div id="statement-section" ref={containerRef} className="relative text-ink overflow-hidden bg-secondary">
      ...
      <div className="relative px-8 md:px-16 py-40 border-t border-ink/8 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto">
          <div className="s-reveal flex items-center gap-3 mb-20">
            <span className="font-mono text-[0.625rem] tracking-[0.22em] uppercase text-stabilo">{dict.strategy_overline || 'The Strategy'}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-24 md:gap-12">
            {steps.map((step, i) => (
              ...
              >
                ...
                <span className="absolute -top-10 -left-6 font-plus-jakarta text-[8rem] font-bold text-ink/[0.03] select-none pointer-events-none group-hover:text-stabilo/[0.05] in-[.is-mobile-active]:text-stabilo/[0.05] transition-colors duration-700">
                  {step.n}
                </span>
                ...
                <div className="flex items-center gap-4">
                  <div className="s-icon-float relative w-20 h-20 flex items-center justify-center">
                    {/* Outer Ring */}
                    <div className="absolute inset-0 rounded-3xl border border-ink/5 rotate-6 group-hover:rotate-12 in-[.is-mobile-active]:rotate-12 group-hover:border-stabilo/30 in-[.is-mobile-active]:border-stabilo/30 transition-transform duration-700" />
                    {/* Main Container */}
                    <div className="relative w-full h-full bg-white/40 backdrop-blur-md border border-ink/10 rounded-3xl flex items-center justify-center shadow-sm group-hover:shadow-xl group-hover:shadow-stabilo/10 group-hover:border-stabilo/20 in-[.is-mobile-active]:shadow-xl in-[.is-mobile-active]:shadow-stabilo/10 in-[.is-mobile-active]:border-stabilo/20 transition-all duration-500">
                      {i === 0 && <Users className="w-8 h-8 text-ink group-hover:text-stabilo in-[.is-mobile-active]:text-stabilo transition-colors duration-500" strokeWidth={1.2} />}
                      {i === 1 && <Layout className="w-8 h-8 text-ink group-hover:text-stabilo in-[.is-mobile-active]:text-stabilo transition-colors duration-500" strokeWidth={1.2} />}
                      {i === 2 && (
                        <div className="relative">
                          <ShoppingCart className="w-8 h-8 text-ink group-hover:text-stabilo in-[.is-mobile-active]:text-stabilo transition-colors duration-500" strokeWidth={1.2} />
                          <div className="absolute -top-1 -right-1 bg-stabilo text-white rounded-full p-0.5 scale-0 group-hover:scale-100 in-[.is-mobile-active]:scale-100 transition-transform duration-500 delay-200">
                    ...
                    {/* Decorative Dot */}
                    <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-stabilo rounded-full border-4 border-background scale-0 group-hover:scale-100 in-[.is-mobile-active]:scale-100 transition-transform duration-500 delay-100" />
                  </div>

                  {i < 2 && (
                    <div className="hidden md:block flex-1 h-px bg-ink/5 relative overflow-hidden">
                      <div className="absolute inset-0 bg-stabilo/20 translate-x-[-100%] group-hover:translate-x-[100%] in-[.is-mobile-active]:translate-x-[100%] transition-transform duration-1000" />
                    </div>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex items-center gap-3">
                    <span className="label-meta text-[0.65rem] text-stabilo font-bold uppercase tracking-widest">{step.badge}</span>
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="font-plus-jakarta text-3xl font-bold tracking-tight text-ink group-hover:text-stabilo in-[.is-mobile-active]:text-stabilo transition-colors duration-300">
                      {step.label}
                    </h3>
                  ...
                  <div className="mt-4 flex items-center gap-2 group/link cursor-pointer">
                    <span className="font-mono text-[0.55rem] tracking-widest uppercase text-ink/40 group-hover/link:text-stabilo in-[.is-mobile-active]:text-stabilo transition-colors">{dict.learn_more}</span>
                    <ArrowRight className="w-3 h-3 text-ink/20 group-hover/link:text-stabilo in-[.is-mobile-active]:text-stabilo transition-all group-hover/link:translate-x-1 in-[.is-mobile-active]:translate-x-1" />
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="px-8 md:px-16 py-32 border-t border-ink/8 flex flex-col items-start lg:items-center bg-secondary/30">
        ...
        <div className="s-reveal mt-20 flex flex-col items-center gap-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-px bg-stabilo/30" />
            <span className="font-mono text-[0.625rem] tracking-[0.4em] uppercase text-ink/40">The Transformation Studio</span>
            <div className="w-12 h-px bg-stabilo/30" />
          </div>
          <span className="font-mono text-[0.625rem] tracking-[0.2em] uppercase text-stabilo font-bold">
            TANGERANG, INDONESIA
          </span>
        </div>
      </div>
