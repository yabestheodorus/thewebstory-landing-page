            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-1">
                <a
                  ...
                  className={`flex-1 flex items-center justify-center gap-2.5 bg-ink text-off font-mono text-[0.5625rem] tracking-widest uppercase py-4 px-6 transition-colors duration-300 hover:bg-stabilo ${!form.name.trim() ? 'opacity-30 cursor-not-allowed' : ''}`}
                >
