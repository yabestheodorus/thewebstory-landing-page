...
const avatars = ['AK', 'RS', 'DM', 'FT']

export default function HeroSection() {
  const { isMobile } = useDevice();
  return (
    <div className="relative flex flex-col min-h-screen bg-off text-ink overflow-hidden">

      {/* Ticker */}
      <div className="relative w-full max-w-full bg-ink text-off py-2.25 overflow-hidden whitespace-nowrap border-b border-border">
      ...
      <div className="flex flex-col  lg:grid lg:grid-cols-2 xl:grid-cols-[56px_1fr_1fr] grow">
        ...
        <div className="hidden xl:flex  flex-col items-center justify-center py-5 gap-5">
        ...
        <div className="pt-10 px-6 pb-12 md:p-10 lg:p-12 xl:pt-12 xl:pr-12 xl:pb-10 xl:pl-10 flex flex-col justify-between min-w-0">
          <div className="flex flex-col justify-center items-center lg:items-start h-full relative">
            ...
            {/* Headline */}
            <h1 className="font-aktiv-grotesk text-[clamp(2.25rem,6vw+0.5rem,3.875rem)] font-bold leading-[1.1] md:leading-none tracking-[-0.02em] text-ink mb-7 text-center lg:text-left mt-36 lg:mt-0">
            ...
            {/* Body copy */}
            <p className="font-google text-sm leading-[1.75] text-muted-warm max-w-[480px] lg:max-w-[420px] mb-10 mt-6 lg:mt-0 text-center lg:text-left ">
        ...
        {/* Right content */}
        <div className="relative flex flex-col justify-between bg-off pb-10 xl:pb-0 overflow-hidden">
      ...
      <div className="relative py-7 border-t border-b border-border overflow-hidden bg-off">
      ...
      {/* Bottom meta */}
      <div className="py-6 px-6 md:px-10 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
