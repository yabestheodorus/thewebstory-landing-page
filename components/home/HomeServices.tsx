    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 pb-32">
        <div className="flex flex-col border-t border-ink/5">
          {dict?.packages?.map((pkg: any, i: number) => (
            <Link
              ...
              className="group relative flex flex-col md:grid md:grid-cols-[1.5fr_1.2fr_auto] gap-y-12 md:gap-y-0 gap-x-16 py-16 md:py-24 border-b border-ink/5 transition-all duration-500"
            >
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center gap-6">
                  ...
                  <h3 className="font-aktiv-grotesk text-[32px] md:text-[64px] font-bold text-ink group-hover:text-stabilo transition-colors duration-500 leading-none">
                    {pkg.tier}
                  </h3>
                </div>
              ...
              <div className="flex flex-col gap-6">
                <span className="label-meta text-ink/20 text-[11px] font-black uppercase tracking-[0.2em]">What's Included</span>
                <ul className="flex flex-col gap-4">
                  {(pkg?.what_you_get?.items || pkg?.features || []).slice(0, 5).map((feature: any, idx: number) => (
                    <li key={idx} className="flex items-start gap-3">
                      ...
                      <span className="label-fn text-ink/60 text-[16px] font-medium leading-tight group-hover:text-ink transition-colors duration-500">
              ...
              <div className="flex flex-col md:items-end justify-between py-2 relative z-10">
                <div className="text-left md:text-right">
                  ...
                  <span className="label-meta text-stabilo font-black text-[12px] uppercase tracking-[0.2em] mt-3 block">{pkg.delivery} delivery</span>
                </div>
                
                <div className="mt-12 md:mt-0 flex items-center justify-center w-16 h-16 rounded-full border border-ink/5 group-hover:bg-stabilo group-hover:border-stabilo group-hover:text-white transition-all duration-500 shadow-sm">
        ...
        <div className="mt-20 md:mt-40 flex flex-col">
          <div className="mb-12">
            <h3 className="label-meta text-stabilo font-bold text-[14px] tracking-[0.3em] uppercase">Premium Add-ons</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            {dict?.addons?.map((addon: any) => (
              <Link
                ...
                className="group flex flex-col gap-6 p-10 md:p-14 rounded-[40px] border border-ink/5 bg-card/30 hover:bg-card/80 hover:border-stabilo/20 hover:shadow-2xl hover:shadow-stabilo/5 transition-all duration-500 relative overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-stabilo/5 blur-3xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                <div className="flex items-center justify-between relative z-10">
                  <h4 className="font-aktiv-grotesk text-[28px] md:text-[36px] font-bold text-ink group-hover:text-stabilo transition-colors">
                    {addon.name}
                  </h4>
                  <div className="w-12 h-12 rounded-full border border-ink/5 flex items-center justify-center group-hover:bg-stabilo group-hover:border-stabilo group-hover:text-white transition-all">
